...
class SelectionSortTest {
	...
	void testFiveElementsArray() {
		...
		int[] result = selectionSort.selectionSort(fiveElementsArray);
	...
	void testFifteenElementsArray() {
		...
		int[] result = selectionSort.selectionSort(fifteenElementsArray);
	...
	void testDuplicateValueArray() {
		...
		int[] result = selectionSort.selectionSort(duplicateValueArray);
