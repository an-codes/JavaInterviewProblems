...
class MergeSortTest {
	...
	private static MergeSort mergeSortInstance;


	@BeforeAll
	static void setUpBeforeClass() throws Exception {
		mergeSortInstance = new MergeSort();
	}
	...
	void testFiveElementsArray() {
		...
		int[] result = mergeSortInstance.mergeSort(fiveElementsArray, leftIndex, rightIndex);
	...
	void testFifteenElementsArray() {
		...
		int[] result = mergeSortInstance.mergeSort(fifteenElementsArray, leftIndex, rightIndex);
	...
	void testDuplicateValueArray() {
		...
		int[] result = mergeSortInstance.mergeSort(duplicateValueArray, leftIndex, rightIndex);
